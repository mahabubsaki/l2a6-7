        ...
        <div className='border-4 border-[#eee]'>
            ...
            <div className='pt-10 pb-8 px-5 flex flex-col gap-4'>
                ...
                <div className='flex gap-2.5 text-[12px] font-semibold'>
                    ...
                    <p className='text-main dark:text-dark-main'>Goal : {goal}</p>
                </div>
                <p className='text-[12px] text-[#9c9c9c]'>{description}</p>
                <div className='flex gap-6 flex-wrap'>
                    <Link to={'/relief/' + _id}>
                        <button className='bg-main w-fit text-[12px] border-main border text-white px-6 py-2.5 rounded-full hover:bg-transparent font-semibold  hover:text-main dark:text-dark-main duration-300'>Details</button></Link>
                    <button className='w-fit text-[12px] border-main border hover:text-white px-6 py-2.5 rounded-full flex items-center gap-1 hover:bg-main bg-white font-semibold  text-main dark:bg-secondary dark:text-dark-main duration-300'><HiHeart />{donaters} Donaters</button>
                </div>
            </div>
