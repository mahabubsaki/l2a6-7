    ...
    return (
        <div className='bg-[#eb5310] px-5  py-[55px] mt-5'>
            <div className=" flex text-center max-w-screen-xl mx-auto xl:text-left items-center flex-col xl:flex-row  gap-20">
                <div className="flex flex-col flex-1  text-white dark:text-black gap-5 ">
                    ...
                    <div className='flex justify-center xl:justify-start'>
                        <button className='bg-white  dark:bg-purple-500 w-fit text-[12px] border-white border text-main  px-6 py-2.5 rounded-full text-sm hover:bg-transparent font-semibold  hover:text-white dark:text-black duration-300'>BE A PART OF US</button>
                    </div>
                </div>
                <div className='flex-1 flex flex-wrap gap-20 justify-center text-white dark:text-black'>
