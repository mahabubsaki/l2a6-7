            ...
            <div className="max-w-md mx-auto mt-5">
                <form action="" className="flex flex-col gap-5">
                    <div>
                        ...
                        <input type="text" id="name" placeholder="Your Name" className='w-full   border-[#c9c9c9] mt-2 text-[#c9c9c9] bg-[#2C353C] text-[14px] py-2 h-[50px] outline-none focus:outline-none duration-300 px-5' />
                    </div>
                    <div>
                ...
                <p>Already have an account? <span className="text-main font-semibold"><Link to={'/auth/LOGIN'}>LOGIN</Link></span> now</p>
