...
const PostOrPutGoods = ({ method, defaultValus, id, onClose, refetch }: { method: 'PUT' | 'POST', defaultValus: { src: string, title: string, collected: string | number, category: string, goal: string | number, description: string, donaters: string | number; } | null; id?: string; onClose?: () => void; refetch?: () => void; }) => {
    ...
    return (
        <form className='flex flex-col gap-5' onSubmit={async (e) => {
            ...
            <div>
                <label htmlFor="title" className="text-main ">Relief Title</label>
            ...
            <div>
                <label htmlFor="src" className="text-main ">Relief Image Link</label>
            ...
            <div>
                <label htmlFor="category" className="text-main ">Relief category</label>
            ...
            <div>
                <label htmlFor="collected" className="text-main ">Relief Amount</label>
            ...
            <div>
                <label htmlFor="goal" className="text-main ">Relief Amount Goal</label>
            ...
            <div>
                <label htmlFor="donaters" className="text-main ">Relief Donaters</label>
            ...
            <div>
                <label htmlFor="description" className="text-main ">Relief Descriptionm</label>
            ...
            <button type='submit' className='bg-main border-main border text-white px-6 py-2.5 rounded-full hover:bg-transparent font-semibold  hover:text-main duration-300'>{method === 'POST' ? 'Create Supply' : 'Update Supply'}</button>
        </form>
    );
};
